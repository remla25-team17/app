...
input_text_length = Histogram("input_text_length", "Distribution of length of input text, measured in number  of characters")
...
def analyze_sentiment():
    ...
    try:
        ...
        input_text_length.observe(len(input_text))
